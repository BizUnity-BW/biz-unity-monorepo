...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    label: 'Quotations',
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 3.75h3M9 8.25h6M6.75 3h10.5A1.5 1.5 0 0118.75 4.5v15A1.5 1.5 0 0117.25 21H6.75A1.5 1.5 0 015.25 19.5v-15A1.5 1.5 0 016.75 3z" />
    ),
  },
  {
    to: '/invoices',
    label: 'Invoices',
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25h6m-6 3h6m-6 3h3.75M6.75 3h10.5a1.5 1.5 0 011.5 1.5v15.75l-3-1.5-2.25 1.5-2.25-1.5-2.25 1.5-3-1.5V4.5a1.5 1.5 0 011.5-1.5z" />
    ),
  },
  {
    to: '/payments',
    label: 'Payments',
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3M3.75 5.25h16.5c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125H3.75c-.621 0-1.125-.504-1.125-1.125V6.375c0-.621.504-1.125 1.125-1.125z" />
    ),
  },
];
